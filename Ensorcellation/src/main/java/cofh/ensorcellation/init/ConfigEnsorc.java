...
public class ConfigEnsorc {
    ...
    private static void genEnchantmentConfig() {
        ...
        COMMON_CONFIG.push("Frost Aspect");
        comment = "If TRUE, the Frost Aspect Enchantment is available for various Weapons.";
        enableFrostAspect = COMMON_CONFIG.comment(comment).define("Enable", true);
        comment = "This option adjusts the maximum allowable level for the Enchantment.";
        levelFrostAspect = COMMON_CONFIG.comment(comment).defineInRange("Max Level", 2, 1, MAX_ENCHANT_LEVEL);
        COMMON_CONFIG.pop();
        ...
        // TOOLS
        COMMON_CONFIG.push("Excavating");
        comment = "If TRUE, the Excavating Enchantment is available for various Tools.";
        enableExcavating = COMMON_CONFIG.comment(comment).define("Enable", true);
        comment = "This option adjusts the maximum allowable level for the Enchantment.";
        levelExcavating = COMMON_CONFIG.comment(comment).defineInRange("Max Level", 2, 1, MAX_ENCHANT_LEVEL);
        COMMON_CONFIG.pop();
        ...
        // HOES
        COMMON_CONFIG.push("Furrowing");
        comment = "If TRUE, the Furrowing Enchantment is available for Hoes.";
        enableFurrowing = COMMON_CONFIG.comment(comment).define("Enable", true);
        comment = "This option adjusts the maximum allowable level for the Enchantment.";
        levelFurrowing = COMMON_CONFIG.comment(comment).defineInRange("Max Level", 4, 1, MAX_ENCHANT_LEVEL);
        COMMON_CONFIG.pop();

        COMMON_CONFIG.push("Tilling");
        comment = "If TRUE, the Tilling Enchantment is available for Hoes.";
        enableTilling = COMMON_CONFIG.comment(comment).define("Enable", true);
        comment = "This option adjusts the maximum allowable level for the Enchantment.";
        levelTilling = COMMON_CONFIG.comment(comment).defineInRange("Max Level", 4, 1, MAX_ENCHANT_LEVEL);
        COMMON_CONFIG.pop();

        COMMON_CONFIG.push("Weeding");
        comment = "If TRUE, the Weeding Enchantment is available for Hoes.";
        enableWeeding = COMMON_CONFIG.comment(comment).define("Enable", true);
        COMMON_CONFIG.pop();
