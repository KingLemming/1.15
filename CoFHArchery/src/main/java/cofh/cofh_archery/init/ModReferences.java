...
public class ModReferences {
    ...
    // region IDS
    public static final String ID_BLAZE_ARROW = ID_COFH_ARCHERY + ":blaze_arrow";
    public static final String ID_DIAMOND_ARROW = ID_COFH_ARCHERY + ":diamond_arrow";
    public static final String ID_ENDER_ARROW = ID_COFH_ARCHERY + ":ender_arrow";
    public static final String ID_EXPLOSIVE_ARROW = ID_COFH_ARCHERY + ":explosive_arrow";
    public static final String ID_FROST_ARROW = ID_COFH_ARCHERY + ":frost_arrow";
    public static final String ID_LIGHTNING_ARROW = ID_COFH_ARCHERY + ":lightning_arrow";
    ...
    public static final String ID_EFFECT_TRAINING_TARGET = ID_COFH_ARCHERY + ":training_target";
    // endregion
