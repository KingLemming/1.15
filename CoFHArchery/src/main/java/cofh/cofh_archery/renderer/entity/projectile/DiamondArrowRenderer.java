...
public class DiamondArrowRenderer extends ArrowRenderer<DiamondArrowEntity> {
    ...
    public static final ResourceLocation TEXTURE = new ResourceLocation("cofh_archery:textures/entity/projectiles/diamond_arrow.png");
    ...
    @Override
    protected ResourceLocation getEntityTexture(DiamondArrowEntity entity) {
