...
public class FrostArrowEntity extends AbstractArrowEntity {
    ...
    protected void func_213868_a(EntityRayTraceResult raytraceResultIn) {
        ...
        if (entity instanceof LivingEntity) {
            ...
            living.addPotionEffect(new EffectInstance(Effects.SLOWNESS, DURATION, AMPLIFIER));
            living.addPotionEffect(new EffectInstance(Effects.WEAKNESS, DURATION, AMPLIFIER));
        }
