...
public class TFndGenLootTables extends LootTableProviderCoFH {

    public TFndGenLootTables(DataGenerator dataGeneratorIn) {
    ...
    protected void addTables() {
        ...
        //        lootTables.put(BLOCKS.get(ID_RUBY_ORE), createSimpleTable(BLOCKS.get(ID_RUBY_ORE)));
        //        lootTables.put(BLOCKS.get(ID_SAPPHIRE_ORE), createSimpleTable(BLOCKS.get(ID_SAPPHIRE_ORE)));
