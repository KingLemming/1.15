...
public class APItems {
    ...
    public static void register() {
        ...
        //        ITEMS.register(ID_BLAZE_ARROW, () -> new BlazeArrowItem(new Item.Properties()).setDisplayGroup(() -> ArchersParadox.itemGroup));
        //        ITEMS.register(ID_CHALLENGE_ARROW, () -> new ChallengeArrowItem(new Item.Properties().rarity(Rarity.UNCOMMON)).setDisplayGroup(() -> ArchersParadox.itemGroup));
        //        ITEMS.register(ID_DIAMOND_ARROW, () -> new DiamondArrowItem(new Item.Properties()).setDisplayGroup(() -> ArchersParadox.itemGroup));
        //        ITEMS.register(ID_DISPLACEMENT_ARROW, () -> new DisplacementArrowItem(new Item.Properties()).setDisplayGroup(() -> ArchersParadox.itemGroup));
        //        ITEMS.register(ID_ENDER_ARROW, () -> new EnderArrowItem(new Item.Properties()).setDisplayGroup(() -> ArchersParadox.itemGroup));
        //        ITEMS.register(ID_EXPLOSIVE_ARROW, () -> new ExplosiveArrowItem(new Item.Properties()).setDisplayGroup(() -> ArchersParadox.itemGroup));
        //        ITEMS.register(ID_FROST_ARROW, () -> new FrostArrowItem(new Item.Properties()).setDisplayGroup(() -> ArchersParadox.itemGroup));
        //        ITEMS.register(ID_GLOWSTONE_ARROW, () -> new GlowstoneArrowItem(new Item.Properties()).setDisplayGroup(() -> ArchersParadox.itemGroup));
        //        ITEMS.register(ID_LIGHTNING_ARROW, () -> new LightningArrowItem(new Item.Properties()).setDisplayGroup(() -> ArchersParadox.itemGroup));
        //        // ITEMS.register(ID_MAGMA_ARROW, () -> new MagmaArrowItem(new Item.Properties()).setDisplayGroup(() -> ArchersParadox.itemGroup));
        //        ITEMS.register(ID_PHANTASMAL_ARROW, () -> new PhantasmalArrowItem(new Item.Properties()).setDisplayGroup(() -> ArchersParadox.itemGroup));
        //        ITEMS.register(ID_PRISMARINE_ARROW, () -> new PrismarineArrowItem(new Item.Properties()).setDisplayGroup(() -> ArchersParadox.itemGroup));
        //        ITEMS.register(ID_QUARTZ_ARROW, () -> new QuartzArrowItem(new Item.Properties()).setDisplayGroup(() -> ArchersParadox.itemGroup));
        //        ITEMS.register(ID_REDSTONE_ARROW, () -> new RedstoneArrowItem(new Item.Properties()).setDisplayGroup(() -> ArchersParadox.itemGroup));
        //        ITEMS.register(ID_SHULKER_ARROW, () -> new ShulkerArrowItem(new Item.Properties().rarity(Rarity.UNCOMMON)).setDisplayGroup(() -> ArchersParadox.itemGroup));
        //        ITEMS.register(ID_SLIME_ARROW, () -> new SlimeArrowItem(new Item.Properties()).setDisplayGroup(() -> ArchersParadox.itemGroup));
        //        ITEMS.register(ID_SPORE_ARROW, () -> new SporeArrowItem(new Item.Properties()).setDisplayGroup(() -> ArchersParadox.itemGroup));
        //        ITEMS.register(ID_TRAINING_ARROW, () -> new TrainingArrowItem(new Item.Properties()).setDisplayGroup(() -> ArchersParadox.itemGroup));
        //        ITEMS.register(ID_VERDANT_ARROW, () -> new VerdantArrowItem(new Item.Properties()).setDisplayGroup(() -> ArchersParadox.itemGroup));
    }
