...
public class EffectsCore {
    ...
    public static void register() {
        ...
        EFFECTS.register(ID_EFFECT_CHILLED, () -> new EffectCoFH(EffectType.HARMFUL, 0x86AEFD).addAttributesModifier(SharedMonsterAttributes.MOVEMENT_SPEED, UUID_EFFECT_CHILLED_MOVEMENT_SPEED.toString(), -0.10F, AttributeModifier.Operation.MULTIPLY_TOTAL).addAttributesModifier(SharedMonsterAttributes.ATTACK_DAMAGE, UUID_EFFECT_CHILLED_ATTACK_DAMAGE.toString(), -3.0D, AttributeModifier.Operation.ADDITION));
