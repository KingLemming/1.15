...
public class PacketMultiModeItem extends PacketBase implements IPacketServer {

    protected boolean decr;

    public PacketMultiModeItem() {
    ...
    private static void sendToServer(boolean decr) {
        ...
        PacketMultiModeItem packet = new PacketMultiModeItem();
        packet.decr = decr;
        packet.sendToServer();
    }
