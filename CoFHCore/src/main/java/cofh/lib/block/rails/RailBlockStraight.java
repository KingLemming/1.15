...
import static cofh.lib.util.constants.Constants.RAIL_STRAIGHT;

public class RailBlockStraight extends RailBlockCoFH {

    public RailBlockStraight(Properties builder) {
