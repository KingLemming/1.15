...
public abstract class AbstractRecipe implements IMachineRecipe {
    ...
    @Override
    public List<ItemStack> getOutputItems(List<? extends IItemStackAccess> inputSlots, List<? extends IFluidStackAccess> inputTanks) {

        return outputItems;
    }

    @Override
    public List<FluidStack> getOutputFluids(List<? extends IItemStackAccess> inputSlots, List<? extends IFluidStackAccess> inputTanks) {
