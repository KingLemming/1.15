...
import cofh.potions.entity.projectile.ShulkerArrowEntity;
...
public class ShulkerArrowRenderer extends ArrowRenderer<ShulkerArrowEntity> {
    ...
    public static final ResourceLocation RES_SHULKER_ARROW = new ResourceLocation("cofh_test:textures/entity/projectiles/shulker_arrow.png");
