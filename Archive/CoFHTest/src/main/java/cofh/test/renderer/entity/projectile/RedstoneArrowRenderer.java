...
import cofh.potions.entity.projectile.RedstoneArrowEntity;
...
public class RedstoneArrowRenderer extends ArrowRenderer<RedstoneArrowEntity> {
    ...
    public static final ResourceLocation RES_REDSTONE_ARROW = new ResourceLocation("cofh_test:textures/entity/projectiles/redstone_arrow.png");
