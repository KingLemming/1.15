...
import static cofh.thermal.expansion.init.TExpReferences.FIRSTBLOCK_TILE;
...
public class FirstBlockTile extends TileEntity implements ITickableTileEntity, INamedContainerProvider {
    ...
    public void tick() {
        ...
        if (counter > 0) {
            counter--;
            if (counter <= 0) {
                energy.ifPresent(e -> e.receiveEnergy(40, false));
            }
            markDirty();
        }
    ...
    private IEnergyStorage createEnergy() {
        ...
        return new EnergyStorageCoFH(32000, 0);
    }
