package cofh.thermal.expansion.block.tutorial;
...
public class FirstBlockContainer extends Container {
    ...
    public FirstBlockContainer(int windowId, World world, BlockPos pos, PlayerInventory playerInventory, PlayerEntity player) {
        ...
        trackInt(new IntReferenceHolder() {
            ...
            public void set(int value) {
                ...
                tileEntity.getCapability(CapabilityEnergy.ENERGY).ifPresent(h -> ((EnergyStorageCoFH) h).setEnergyStored(value));
            }
        });
    }
    ...
    public boolean canInteractWith(PlayerEntity playerIn) {
        ...
        return isWithinUsableDistance(IWorldPosCallable.of(tileEntity.getWorld(), tileEntity.getPos()), playerEntity, FIRSTBLOCK);
    }
