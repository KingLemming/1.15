...
public class TExpBlocks {
    ...
    public static void register() {
        ...
        registerBlock(ID_MACHINE_SMELTER, () -> new TileBlock4Way(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(2.0F).lightValue(14), MachineSmelterTile::new));
        ...
        registerBlock(ID_MACHINE_CHILLER, () -> new TileBlock4Way(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(2.0F).lightValue(0), MachineChillerTile::new));
        ...
        registerBlock(ID_MACHINE_BREWER, () -> new TileBlock4Way(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(2.0F).lightValue(0), MachineBrewerTile::new));
        registerBlock(ID_MACHINE_BOTTLER, () -> new TileBlock4Way(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(2.0F).lightValue(0), MachineBottlerTile::new));
        ...
        registerBlock(ID_DYNAMO_COMPRESSION, () -> new TileBlockDynamo(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(2.0F).lightValue(7), DynamoCompressionTile::new));
        registerBlock(ID_DYNAMO_MAGMATIC, () -> new TileBlockDynamo(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(2.0F).lightValue(7), DynamoMagmaticTile::new));
        registerBlock(ID_DYNAMO_NUMISMATIC, () -> new TileBlockDynamo(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(2.0F).lightValue(7), DynamoNumismaticTile::new));
        registerBlock(ID_DYNAMO_LAPIDARY, () -> new TileBlockDynamo(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(2.0F).lightValue(7), DynamoLapidaryTile::new));
