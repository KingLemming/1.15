...
import cofh.thermal.core.client.renderer.entity.model.BlitzProjectileModel;
...
public class BlitzProjectileRenderer extends EntityRenderer<BlitzProjectileEntity> {
    ...
    private final BlitzProjectileModel<BlitzProjectileEntity> model = new BlitzProjectileModel<>();
