...
import cofh.thermal.core.client.renderer.entity.model.BlizzProjectileModel;
...
public class BlizzProjectileRenderer extends EntityRenderer<BlizzProjectileEntity> {
    ...
    private final BlizzProjectileModel<BlizzProjectileEntity> model = new BlizzProjectileModel<>();
