...
public class RedstoneFluid extends FluidCoFH {
    ...
    protected RedstoneFluid(String key, String stillTexture, String flowTexture) {
        ...
        block = BLOCKS.register(key, () -> new RedstoneFluidBlock(stillFluid, Block.Properties.create(Material.WATER).doesNotBlockMovement().hardnessAndResistance(100.0F).noDrops()));
