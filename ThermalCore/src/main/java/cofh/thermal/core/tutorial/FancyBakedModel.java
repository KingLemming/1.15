package cofh.thermal.core.tutorial;
...
public class FancyBakedModel implements IDynamicBakedModel {
    ...
    public static final ResourceLocation TEXTURE = new ResourceLocation(ID_THERMAL, "block/fancyblock");

    private TextureAtlasSprite getTexture() {

        return RenderHelper.getTexture(TEXTURE);
    }
