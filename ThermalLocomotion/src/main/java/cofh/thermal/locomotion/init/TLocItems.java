...
public class TLocItems {
    ...
    public static void register() {
        ...
        ITEMS.register(ID_PHYTO_TNT_CART, () -> new MinecartItemCoFH(PhytoTNTMinecartEntity::new, new Item.Properties().group(group)).setShowInGroups(getFeature(FLAG_PHYTOGRO)));
